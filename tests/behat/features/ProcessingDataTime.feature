...
# The following field will be used to chech testing result.
    ...
    And I wait 3 seconds
    When I fill in "#edit-field-rep-start-0-value-date" with date "04/27/2023"
    And I wait 3 seconds
...
# Here is testing when "Require manual entry of processing times" checked.
    ...
    And I press the 'Save' button
    And I wait 5 seconds
# verifying fields: report start date and manual processing times checkbox.
    And I click 'Edit'
    And I wait 5 seconds
...
# Create testing Annual Report node.
    ...
    And for 'Date Prepared' I enter '04/27/2023'
...
# Save Annual Report in "Cleared" state.
    ...
    And I click 'Edit'
    And I wait 5 seconds
# Save Annual Report in "Published" state
    And I select "Published" from "Change to"
    And I press the 'Save' button
    And I wait 5 seconds

# The following block only for verifying field value change by annual report.
