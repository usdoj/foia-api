...
Feature: Request template Feature
  ...
  Scenario: Ensure common universal fields in form template
    ...
    And I am at 'webform/basic_request_submission_form/test'
    And I should see a 'Prefix/Title' field
    ...
    And I should see a 'Email Address' field
    ...
    And I should see a 'State/Provence' field
    And I should see a 'Zip/Postal Code' field
    And I should see a 'Processing Fees' field
    And I should see a 'Delivery Method' field
    And I should see a 'Requester Category' field
    And I should see a 'Request Description' field
    ...
    And I should see a 'Electronic Signature / Non SPAM Verification' field
